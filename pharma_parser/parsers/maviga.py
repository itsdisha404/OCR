"""
maviga.py — Maviga Logisys
GSTIN: 07AARCM6852G1ZZ
Digital PDF, 6 pages, 126 line items — the largest invoice.
Has MFG company code column. Multi-vendor distribution.
"""
...
class Parser(GenericParser):
    ...
    def _find_columns(self, header_row: list) -> dict:
        ...
        for i, cell in enumerate(header_row or []):
            ...
            if "product" in h or "desc" in h or "goods" in h or "material" in h:
                col["product"] = i
            elif "hsn" in h:
                col["hsn"] = i
            elif "batch" in h:
