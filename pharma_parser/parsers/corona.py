"""
corona.py — Corona Remedies
GSTIN: 07AACCC5173F1ZU
Digital PDF, 3 pages. Has Division column (Aarush, Aura, Blaze, etc.).
Products: Trazer, Rosuless, Ivapace, Obimet, Vitneurin etc.
"""
    ...
    def _find_columns(self, header_row: list) -> dict:
        ...
        for i, cell in enumerate(header_row or []):
            ...
            if "product" in h or "desc" in h:
                ...
                col["expiry"] = i
            elif "division" in h or "div" in h:
                col["division"] = i
            elif "mfg" in h:
                col["mfg"] = i
            elif "mrp" in h:
