"""
nidhi.py — Nidhi Associates
GSTIN: 07AAACN3519N1ZA
Digital PDF, 4 pages, 119 items. Uses 8.5% discount across all items.
Rate column = OMRP (Original MRP).
"""
...
class Parser(GenericParser):
    ...
    def _parse_row(self, row, col, sr):
        ...
        discount = parse_amount(g("disc")) or 8.5  # default 8.5% for Nidhi
        ...
        return {
            ...
            "pts": 0.0,
            "rate": parse_amount(g("mrp")),  # OMRP = rate
